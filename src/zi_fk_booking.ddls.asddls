...
@EndUserText.label: 'Travel Booking CDS Iterface View'
...
define view entity ZI_FK_BOOKING
  as select from /dmo/booking as _Booking
  association        to parent ZI_FK_TRAVEL_HDR as _Travel     on  $projection.TravelId = _Travel.TravelId
